...
# -*- coding: utf-8 -*-
#
# partbrowser documentation build configuration file
#
...
_version_py = os.path.join(repo, 'partbrowser', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'partbrowserdoc'
...
latex_documents = [
    (master_doc, 'partbrowser.tex', 'partbrowser Documentation',
     'ShapeSpace', 'manual'),
]
